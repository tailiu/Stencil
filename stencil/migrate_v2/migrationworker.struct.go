...
func (mWorker *MigrationWorker) HandleWaitingList(appMapping config.Mapping, tagMembers []string, node *DependencyNode) (*DependencyNode, error) {
...
func (mWorker *MigrationWorker) HandleUnmappedTags(node *DependencyNode) error {
...
func (mWorker *MigrationWorker) HandleLeftOverWaitingNodes() {
