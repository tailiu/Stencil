 ...
 *								messages(0 - 400,000), comments(0 - 400,000),
 *								likes(0 - 200,000), notifications(0 - 500,000)) (last check point)
 *
 *							(users, profiles, people, conversation_visibilities, conversations, 
 *								photos, contacts, messages, posts,
 *								messages(0 - 400,000), comments(0 - 1,000,000),
 *								likes(0 - 800,000), notifications(0 - 1,500,000), 
 								notification_actors(0 - 500,000 needs to be repopulated))
 * 
 * 		{1, 7}, 		// 1. aspects						(401,924) 
 *		{7, 9},			// 2. comments						(1,348,745) (13) My machine (1,000,000 - 1,200,000)
 *		{9, 10},		// 3. contacts						(519,572) (done) 
 *		{10, 11},		// 4. conversations					(8,151) (done)
 *		{11, 13},		// 5. messages						(540,120) (done)
 *		{13, 14},		// 6. notification_actors			(4,672,224) (10) My machine (500,000 -  1,000,000)
 *		{14, 19},		// 7. notifications					(4,672,224) (12) My machine (1,500,000 - 2,000,000)
 ...
 *		{41, 52},		// 16. likes						(3,055,543) (11) My machine (800,000 - 1000,000)
