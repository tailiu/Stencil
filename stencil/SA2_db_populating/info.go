 ...
 *								photos, contacts, messages, posts, comments,
 *								messages(0 - 400,000), likes(0 - 1,000,000), notifications(0 - 2,000,000), 
 *								notification_actors(0 - 1,000,000))
 * 
 * 		{1, 7}, 		// 1. aspects						(401,924) (13) My machine (0 - 100,000)
 *		{7, 9},			// 2. comments						(1,348,745) (done)
 *		{9, 10},		// 3. contacts						(519,572) (done) 
 *		{10, 11},		// 4. conversations					(8,151) (done)
 *		{11, 13},		// 5. messages						(540,120) (done)
 *		{13, 14},		// 6. notification_actors			(4,672,224) (10) My machine (1,000,000 - end)
 *		{14, 19},		// 7. notifications					(4,672,224) (12) My machine (2,000,000 - end)
