 ...
 *								messages(0 - 400,000), posts(0 - 600,000), comments(0 - 400,000),
 *								likes(0 - 200,000), notifications(0 - 500,000))
 * 
 * 		{1, 7}, 		// 1. aspects						(401,924) 
 *		{7, 9},			// 2. comments						(1,348,745) (13) My machine (400,000 - 600,000)
 ...
 *		{14, 19},		// 7. notifications					(4,672,224) (12) My machine (500,000 - 1,000,000)
 *		{19, 20},		// 8. people						(100,481) (done)
 *		{20, 26},		// 9. photos						(369,170) (done)
 *		{26, 27},		// 10. posts						(756,700) * (10) My machine (600,000 - end)
 ...
 *		{41, 52},		// 16. likes						(3,055,543) (11) My machine (200,000 - 400,000)
